...
class RegistrationSwitchModalWidget extends StatefulWidget {
  final RegistrationEntity registration;
  const RegistrationSwitchModalWidget({
    super.key,
    required this.registration,
  });

  @override
  State<RegistrationSwitchModalWidget> createState() =>
      _RegistrationSwitchModalWidgetState();
}

class _RegistrationSwitchModalWidgetState
    extends State<RegistrationSwitchModalWidget> {
