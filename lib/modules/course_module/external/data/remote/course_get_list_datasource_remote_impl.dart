...
class CourseGetListDataSourceRemoteImpl implements CourseGetListDataSource {
  final Dio dio;

  CourseGetListDataSourceRemoteImpl(this.dio);

  @override
  CourseGetListResult call(List<CourseEntity> entities) async {
    try {
      final response = await dio.get('/curso/');
